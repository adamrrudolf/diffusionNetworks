...
Presented methods are inspired by [[http://nipy.org/dipy/documentation.html ][examples]] provided by Dipy project. [[http://nipy.org/dipy/][Dipy]] is a free and open-source community-developed Python tool for analysis of the diffusion imaging data.
