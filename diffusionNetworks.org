...
There are dependencies one have to install in order to use provided code. Installation guide can be found at the website of Dipy: http://nipy.org/dipy/installation.html. You need main libraries and optional python-vtk and matplotlib libraries for visualizations.
